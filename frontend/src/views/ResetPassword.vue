...
<template>
    <GuestLayout  title="Set new password">
        <form class="space-y-6" action="#" method="POST">
            <div>
                <label for="new-password" class="block text-sm font-medium leading-6 text-gray-900">Set a new
                    password</label>
                <div class="mt-2">
                    <input id="new-password" name="password" type="password" required="" placeholder="Set a new password"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                </div>
            </div>

            <div>
                <label for="password-repeat" class="block text-sm font-medium leading-6 text-gray-900">Repeat
                    password</label>
                <div class="mt-2">
